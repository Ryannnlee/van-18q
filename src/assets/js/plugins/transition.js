...
var PageTransitions = (function() {
    ...
    var startPageIndex = 0,
        ...
        // animation end event name 動畫結束事件名稱
    ...
    function init() {
        ...
        // Get all the .pt-page div. 獲取所有的.pt-page div。
        ...
        // 獲取所有pt-div的父對象的所有.pt-wrapper div
        $('.pt-wrapper').each(function() {
            ...
            /* tinglun1014 */
            $wrapperDiv.parent("body").addClass('fp-viewing-page' + (startPageIndex + 1));

            /* tinglun1014 */
        });

        // Adding click event to .pt-trigger 將點擊事件添加到.pt-trigger
        ...
        /* tinglun1014 */
        scrollEventSet();
        if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) { swipeontouch(); } else {}
    ...
    function Animate($pageTrigger) {
        ...
        switch (selectedAnimNumber) {
            ...
            case 29:
                ...
                break;
            case 30:
                inClass = 'pt-page-moveFromTop pt-page-delay200';
        ...
        // 檢查'data-goto'值是否大於'pt-wrapper'內的總頁數
        ...
        if (!support) {
            onEndAnimation($('.pt-wrapper'), $nextPage, $currentPage);
        }
    ...
    function scrollEventSet() {
        $('.pt-wrapper').on('mousewheel', _.debounce(function(event) {
            if (event.deltaY < 0) {
                noLoopDown();
            } else {
                noLoopUP();
    ...
    function noLoopDown() {
        ...
        if ($('section:last-of-type').hasClass('pt-page-current')) {
            return false;
        } else {
    ...
    function noLoopUP() {
        if ($('section:first-of-type').hasClass('pt-page-current')) {
            return false;
        } else {
    ...
    function scrollpaneDown() {
        ...
        //     $('.wireframe-content').on('scroll',function(){
        //         last=$(".scrollpane").height()-$('.wireframe-content').height();
        //         if($('.wireframe-content').scrollTop() == last ){ 
        //             $("#nextpage").trigger("click");
        //         } 
        //         // else if ( $('.wireframe-content').scrollTop() == 0 ) {
        //         //     $("#prevpage").trigger("click");
        //         // }
        //     });
    }
    ...
    //     $('.wireframe-content').on('scroll',function(){
    //         if( $('.wireframe-content').scrollTop() == 0 ){
    //              $("#prevpage").trigger("click");
    //         } 
    //     });
    // }
